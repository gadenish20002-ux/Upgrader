    ...
    <div className="w-full flex flex-col gap-6">
      <div className="!mb-0 grid w-full grid-cols-1 gap-1 px-3 lg:grid-cols-3 lg:gap-3">
        {visibleGames.map((g, index) => {
          ...
          return (
            <div key={g.id} className="group/item animate-custom-bounce relative flex h-[12.5rem] w-full items-center justify-center gap-1 rounded-[1.125rem] bg-[#1E1F23] p-3 shadow-[0_10px_20px_0_rgba(0,0,0,0.10)] hover:!z-[11]" style={{ animationFillMode: 'both' }}>
