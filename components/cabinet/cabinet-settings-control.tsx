...
// Personal-cabinet settings — identical to the admin SettingsControl but scoped
// to the current key's own account and WITHOUT the global admin-password field
// (that belongs to the super-admin only). All fields here are account-scoped.
export function CabinetSettingsControl() {
  ...
  return (
    <section className="rounded-xl border border-border bg-card p-5">
      <div className="mb-4 flex items-center gap-2">
        ...
        <h2 className="font-semibold">Настройки аккаунта</h2>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => {
              const skinSelect = document.getElementById('cabinet-skin-select') as HTMLSelectElement
              const actionSelect = document.getElementById('cabinet-action-select') as HTMLSelectElement
